...
### head
Es un objeto que declararemos con que libros y hojas vamos a trabajar, estas se cargaran en memoria por lo que solamente declararemos solo aquellas que usaremos, también se tienen que incluir todos los archivos y hojas referenciados para poder satisfacer las dependencias. 
...
El JSON que nos devuelve excelToApp puede variar según el JSON entrada pero por ejemplo en el JSON de entrada mensionado arriba lucira asi
